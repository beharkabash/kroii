...
export class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    ...
    console.error('[ErrorBoundary] Virhe kiinni saatu:', error);
    console.error('[ErrorBoundary] Virhetiedot:', errorInfo);

    // Log additional context for debugging
    console.error('[ErrorBoundary] Komponenttipino:', errorInfo.componentStack);
    console.error('[ErrorBoundary] Aikaleima:', new Date().toISOString());

    // In production, you could send this to your preferred error tracking service
    if (process.env.NODE_ENV === 'production') {
      // Example: send to your analytics or monitoring service
      try {
